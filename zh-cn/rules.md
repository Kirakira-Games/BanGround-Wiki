...
2020-12-26：社区内测过半，对一些项目进行符合现状的更新。
...
寻找自己喜爱的谱面，用于展示通过和优质的谱面供用户浏览。用户可以在这一板块中按关键词或筛选条件进行谱面搜索，并浏览感兴趣的谱面，预览谱面内容，或是对谱面发表自己的看法。


### 用户中心

查看、修改自己的信息，以及做出一些安全方面的变动。

### 审核中心

用于审核最近的新谱面。审核者可以对一张谱面发表自己的看法，当足够多的的审核者认可一张谱面，或不认可一张谱面时，它将会进入“待通过”状态或“退回”状态。
...
为BanGround社区捐赠款项，同时获得一些特殊奖励。所有的捐赠记录和捐赠的使用明细也会在此公示。
...
高质量谱面审核周期为7天，若在周期结束时，谱面有20次**收藏**，且有2名审核者给予**高质量**评价，谱面将成为**High-Quality**谱面。
...
用户可以按月（31天）赞助，获取赞助者资格。获取赞助者资格的拥有特权：更多的“鱼干”奖励、先行体验社区新版游戏以及社区赞助者头衔等。
...
虽然游戏是免费的，但是社区服务器运转需要大量资金，我们无法一力承担这些开销，所以需要赞助来维持社区的运行。

服务器费用、流量费用和iOS开发者证书将会成为主要的支出。做一个简单的计算：

* 当前使用的服务器包年费用（8.3折后价格）为**3640.38元**。

* 一个音乐文件以4MB计，每人每天下载3个新音乐，每天有1000活跃用户，则流量为1000×3×4MB=12GB；目前使用的腾讯云CDN在中国大陆地区的费用为0.21元/GB\*，可得每天流量支出为12GB×0.21元/GB=2.52元，一年（按365天计）支出**919.8元**。

  \* 该费用为2020年12月26日查询的结果。

* iOS开发者证书一年为99美元，约合人民币**650元**\*。

  \* 该费用为北京时间2020年12月26日上午10:00查询得到的汇率（1美元=6.5418人民币）换算得到的。

以上费用合计约5200元。

由于社区管理组没有能力独立承担这些费用，故需要赞助来维持运行。

#### 赞助奖励

赞助者可以在社区中获得一定的特权。

这些特权随时可能会新增、变更或删除，请您知悉。

* 对应赞助等级的徽章
* Supporter Ⅲ及以上：根据赞助等级变更昵称样式
* Supporter Ⅳ及以上：Beta版本试用
...
| -------------------------- | :--: | -------------------------- | -------------------------- | -------------------------- | -------------------------- | -------------------------- |
| 每日签到 | 300 | 400 | 600 | 800 | 1300        | 2000 |
| 每月签到                   | 1200 | 1600 | 2400 | 3200 | 5200 | 8000 |
| **每月合计（按30天计算）** | 9900 | 13200 | 19800 | 26400 | 42900 | 66000 |

##### 上传成绩

| 行为                                 | Easy奖励 | Normal奖励 | Hard奖励 | Expert/Special奖励 |
| ------------------------------------ | :------: | :--------: | :------: | :----------------: |
| 每张谱面首次上传S等级及以上成绩      |   100    |    100     |   200    |        300         |
| 每张谱面首次上传SS等级及以上成绩     |   100    |    100     |   300    |        400         |
| 每张谱面首次上传SSS等级成绩          |   100    |    200     |   400    |        700         |
| 每张谱面首次上传Full Combo及以上成绩 |   100    |    200     |   300    |        500         |
| 每张谱面首次上传All Perfect成绩      |   100    |    200     |   400    |        700         |
| **合计**                             |   500    |    800     |   1600   |        2600        |
